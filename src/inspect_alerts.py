...
# ==================================================
# SAVE TOP HIGH-RISK DISTRICT-MONTHS
# ==================================================
...
district_summary["alert_rate"] = district_summary["n_alerts"] / district_summary["n_months"]
...
monthly_summary["alert_share"] = monthly_summary["n_alerts"] / monthly_summary["n_districts"]
...
# ==================================================
# OPTIONAL: HIT / FALSE ALARM TABLE
# ==================================================
df["alert_result"] = "TN"
df.loc[(df["drought_alert"] == 1) & (df["drought_next_actual"] == 1), "alert_result"] = "TP"
df.loc[(df["drought_alert"] == 1) & (df["drought_next_actual"] == 0), "alert_result"] = "FP"
df.loc[(df["drought_alert"] == 0) & (df["drought_next_actual"] == 1), "alert_result"] = "FN"
